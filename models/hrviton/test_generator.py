...
import os
import time
from models.hrviton.cp_dataset_test import CPDatasetTest, CPDataLoader
...
def get_opt():
    ...
    parser.add_argument("--dataroot", default="models/hrviton/my_data/")
    ...
    parser.add_argument('--tensorboard_dir', type=str, default='models/hrviton/tensorboard/', help='save tensorboard infos')
    parser.add_argument('--checkpoint_dir', type=str, default='models/hrviton/checkpoints/', help='save checkpoint infos')
    parser.add_argument('--tocg_checkpoint', type=str, default='models/hrviton/checkpoints/mtviton.pth', help='tocg checkpoint')
    parser.add_argument('--gen_checkpoint', type=str, default='models/hrviton/checkpoints/gen.pth', help='G checkpoint')  
